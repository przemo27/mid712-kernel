...
int screen_x[] 	= { 50,  974,   50,  974,  512};
int screen_y[] 	= { 50,   50,  550,  550,  300};
int uncali_x[] 	= {264, 3839,  268, 3839, 2047};
int uncali_y[] 	= {3710,  3727, 480, 535, 2119};

#elif defined(CONFIG_BOARD_RK5900) //rk5900
#define LCD_MAX_LENGTH					 	800
#define LCD_MAX_WIDTH					 	480
int screen_x[] 	= { 50,  750,   50,  750,  400};
int screen_y[] 	= { 40,   40,  440,  440,  240};
int uncali_x[] 	= {345, 3745,  350, 3745, 2050};
int uncali_y[] 	= {495,  510, 3660, 3663, 2085};
#elif defined(CONFIG_BOARD_BM730)  ///bm 7'
#define LCD_MAX_LENGTH					 	800
#define LCD_MAX_WIDTH					 	480
int screen_x[] 	= { 50,  750,   50,  750,  400};
int screen_y[] 	= { 40,   40,  440,  440,  240};
...
int screen_x[] 	= { 50,  974,   50,  974,  512};
int screen_y[] 	= { 50,   50,  550,  550,  300};
int uncali_x[] 	= {3424, 3460, 876, 744, 2076};
int uncali_y[] 	= {372,  3591, 443, 3415, 1990};

#elif defined(CONFIG_BOARD_IPAD100) 

#define LCD_MAX_LENGTH					 	1024
#define LCD_MAX_WIDTH					 	576
//int screen_x[] 	= { 50,  974,   50,  974,  512};
//int screen_y[] 	= { 50,   50,  550,  550,  300};
//int uncali_x[] 	= {264, 3839,  268, 3839, 2047};
//int uncali_y[] 	= {3710,  3727, 480, 535, 2119};
...
int screen_x[] 	= { 50,  974,   50,  974,  512};
int screen_y[] 	= { 50,   50,  526,  526,  288};
int uncali_x[] 	= {3424, 3460, 876, 744, 2076};
int uncali_y[] 	= {372,  3591, 443, 3415, 1990};

#elif defined(CONFIG_BOARD_IPAD)||defined(CONFIG_BOARD_IPADV5)||defined(CONFIG_BOARD_NM701)||defined(CONFIG_BOARD_ZTX)
...
int screen_x[] 	= 	{ 50,  750,   50,  750,  400};
int screen_y[] 	= 	{ 40,   40,  440,  440,  240};
int uncali_x[] 	= 	{3693, 330,  3670, 330, 2000};
int uncali_y[] 	= 	{588,  520, 3400, 3420, 2020};
...
int screen_x[] 	= 	{ 50,  750,   50,  750,  400};
int screen_y[] 	= 	{ 40,   40,  440,  440,  240};
int uncali_x[] 	= 	{85, 889,  84, 902, 496};
int uncali_y[] 	= 	{133,  139, 853, 864, 506};
...
int screen_x[] 	= { 50,  974,   50,  974,  512};
int screen_y[] 	= { 50,   50,  718,  718,  384};
int uncali_x[] 	= {3424, 3460, 876, 744, 2076};
int uncali_y[] 	= {372,  3591, 443, 3415, 1990};
