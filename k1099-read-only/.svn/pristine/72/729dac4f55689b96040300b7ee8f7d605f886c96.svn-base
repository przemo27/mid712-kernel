...
//  Version 1.03	2006/11/06
//  Version 1.04    2007/01/17
...
//#define TV_HDMI_HDCP    //  cwz open only for HDCP test
...
//extern uint8 int_s1, int_s2, int_s3;
extern uint8 HDMI_Mode_Auto_Manual,HDMI_Lowpower_Mode;

typedef     void (*pCallBack)(uint8 Par);
...
#define ANX7150_READ_PARSE_EDID 0x03
#define ANX7150_CONFIG_VIDEO 0x04
#define ANX7150_CONFIG_AUDIO 0x05
#define ANX7150_CONFIG_PACKETS 0x06
#define ANX7150_HDCP_AUTHENTICATION 0x07
#define ANX7150_PLAY_BACK 0x08
#define ANX7150_RESET_LINK 0x09
#define ANX7150_WAIT_RX_SENSE 0x0a
...
void  HDMI_Set_HPD(uint8 hpd); //ANX7150 Set HPD flag for CPU
uint8  HDMI_Get_HPD(void);//CPU call this funtion to check HPD
...
int  HDMI_System_Init(void);
void HDMI_System_Task(void);

void  HDMI_Set_Video_Format(uint8 video_format);
void  HDMI_Set_Audio_Fs( uint8 audio_fs);
...
//void ANX7150_User_Change_Input (void);		//wen
