...
/* ATHENV */
        ...
        case AR6000_XIOCTL_HTC_RAW_CLOSE:
	    	...
	    	//printk("AR6K: AR6000_XIOCTL_HTC_RAW_CLOSE\n");
			//*/ ATHENV V7.2 ---
            if (arRawIfEnabled(ar)) {
				//*/ ATHENV V7.2 +++
				// Without this, ART application can not run well on 8K Android
	        	//printk("AR6K: AR6000_XIOCTL_HTC_RAW_CLOSE ret=%d\n", ret);
				//*/ ATHENV V7.2 ---
        ...
        case AR6000_XIOCTL_HTC_RAW_READ:
			//*/ ATHENV V7.2 +++
			// Without this, ART application can not run well on 8K Android
	    	//printk("AR6K: AR6000_XIOCTL_HTC_RAW_READ\n");
			//*/ ATHENV V7.2 ---
            if (arRawIfEnabled(ar)) {
        ...
        case AR6000_XIOCTL_HTC_RAW_WRITE:
			//*/ ATHENV V7.2 +++
			// Without this, ART application can not run well on 8K Android
	    	//printk("AR6K: AR6000_XIOCTL_HTC_RAW_WRITE\n");
			//*/ ATHENV V7.2 ---
            if (arRawIfEnabled(ar)) {
                unsigned int streamID;
                get_user(streamID, (unsigned int *)userdata);
