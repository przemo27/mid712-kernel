...
extern void rk28_add_at_key_device(void);
extern void rk28_add_mouse_device(void);
...
static void rk28_power_on(void)
{
	...
	rockchip_mux_api_set(GPIOF5_APWM3_DPWM3_NAME, IOMUXB_GPIO1_B5);	/*PWR_ON*/
	rockchip_mux_api_set(GPIOE_SPI1_SEL_NAME, IOMUXA_GPIO1_A1237);	/*PLAY_ON*/
#if 1
...
static void rk28_power_off(void)
{
	...
	GPIOSetPinLevel(GPIOPortF_Pin5,GPIO_LOW);	/*power down*/
		if(GPIOGetPinLevel(GPIOPortF_Pin5) == 0)	/*avoid alway set gpio during poor battery*/
			break;
...
/*AD button*/
	...
	/*ps2 at key board*/
	rk28_add_at_key_device();
	/*ps2 mouse*/
	rk28_add_mouse_device();
	 /* SPI */
