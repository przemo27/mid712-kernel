...
#define SOCAM_SENSOR_UYVY	(1 << 12)
#define SOCAM_SENSOR_YUYV	(1 << 13)
...
{
	unsigned long common_flags, hsync, vsync, pclk, sensor_yuv;
	...
	sensor_yuv = common_flags & (SOCAM_SENSOR_UYVY | SOCAM_SENSOR_YUYV);

	return (!hsync || !vsync || !pclk || !sensor_yuv) ? 0 : common_flags;
}
