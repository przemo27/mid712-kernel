...
/*
 * Logic for a rk1000_codec as connected on a rockchip board.
 */
static int rockchip_rk1000_codec_init(struct snd_soc_codec *codec)
{
	int i;
...
static struct snd_soc_dai_link rockchip_dai = {
	  .name = "RK1000_CODEC",
	  .stream_name = "RK1000 PCM",
	  .cpu_dai = &rockchip_i2s_dai,
	  .codec_dai = &rk1000_codec_dai,
	  .init = rockchip_rk1000_codec_init,
	  .ops = &rockchip_ops,
};

static struct snd_soc_machine snd_soc_machine_rockchip = {
	  .name = "ROCKCHIP_RK1000_CODEC",
	  .dai_link = &rockchip_dai,
	  .num_links = 1,
};

static struct rk1000_codec_setup_data rockchip_rk1000_codec_setup = {
	  .i2c_address = 0x60,
};
...
static struct snd_soc_device rockchip_snd_devdata = {
	  ...
	  .codec_dev = &soc_codec_dev_rk1000,
	  .codec_data = &rockchip_rk1000_codec_setup,
};
