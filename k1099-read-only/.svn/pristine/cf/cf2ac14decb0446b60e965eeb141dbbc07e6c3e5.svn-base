...
static struct rk28fb_gpio rk28_fb_gpio_info = {
#if defined(CONFIG_BOARD_RK5900)    || defined(CONFIG_BOARD_BM730) 
    .lcd_cs     =0,
    .display_on = (GPIO_HIGH<<16)|GPIOPortB_Pin2,
    .lcd_standby = 0,
#elif defined(CONFIG_BOARD_BM999)  
    .lcd_cs     =0,
    .display_on = (GPIO_HIGH<<16)|GPIOPortB_Pin2,
	.lcd_standby = (GPIO_HIGH<<16)|GPIOPortH_Pin6,
#elif defined(CONFIG_BOARD_IPAD)||defined(CONFIG_BOARD_IPADV5)||defined(CONFIG_BOARD_IPADY1006)\
	||defined(CONFIG_BOARD_E700)||defined(CONFIG_BOARD_TD05D6)||defined(CONFIG_BOARD_TD10D6)\
    ...
    .lcd_standby = 0,
#elif defined(CONFIG_MACH_PWS700AA)
    .lcd_cs     = (GPIO_LOW<<16)|GPIOPortB_Pin2,
    .display_on = (GPIO_LOW<<16)|GPIOPortF_Pin1,
    ///.lcd_standby = (GPIO_LOW<<16)|GPIOPortF_Pin1,
#else
...
******************************************************************************************/
	...
	void __init rk28_add_device_mmc(void)
	{
            ...
            rockchip_mux_api_set(GPIOF4_APWM2_MMC0WPT_NAME, IOMUXA_GPIO1_B4);
            GPIOSetPinDirection(GPIOPortF_Pin4,GPIO_OUT);
...
//zfl
static struct platform_device rk28_ir_device = {
	.name		= "rk28_IR_button",
	.id 	= -1,
};
void rock28_add_device_ir(void)
{
	//printk("\n____________rock28_adddevice_key___________");
	platform_device_register(&rk28_ir_device);
...
static struct rk28bl_info rk28_bl_info = {
	...
	||defined(CONFIG_BOARD_ZTX)
        .pwm_id   = 0,
        .pw_pin   = GPIO_HIGH| (GPIOPortF_Pin1 << 8) ,		//  PWM0->PF2
        .bl_ref   = 1,										//  PWM_EN->PF1
...
#elif defined(CONFIG_MACH_PWS700AA)
        .pwm_id   = 0,
        .pw_pin   = GPIO_LOW | (GPIOPortF_Pin1 << 8) ,
        .bl_ref   = 0,
...
#ifdef CONFIG_MACH_PWS700AA
      GPIOSetPinDirection(GPIOPortH_Pin6,GPIO_OUT); ///rest mac
	  GPIOSetPinLevel(GPIOPortH_Pin6,GPIO_HIGH);
#endif
