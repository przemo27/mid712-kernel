...
//      key		--->	EV	
#define 	LED_CONTROL_PIN	GPIOPortB_Pin3		// key led control
#if 1
...
static  ADC_keyst ad2valuetab[] = {
	...
	{661, KEY_ESC},
/*
	{95,  AD2KEY3},		//  92A	D2KEY1
	{249, AD2KEY4},		//  246  AD2KEY2
	{496, AD2KEY6},		// 406
	{561, AD2KEY4},	
	{611, AD2KEY5},		// 658
	{899, AD2KEY6},
...
if(LED_Delay_Counter==LED_LIGHT_TIME){
	GPIOSetPinDirection(LED_CONTROL_PIN, GPIO_OUT);
	GPIOSetPinLevel(LED_CONTROL_PIN, GPIO_HIGH);
	LED_Delay_Counter--;
}else{	
	if(LED_Delay_Counter>0){
		LED_Delay_Counter--;
		if(LED_Delay_Counter==1){
		GPIOSetPinDirection(LED_CONTROL_PIN, GPIO_OUT);
		GPIOSetPinLevel(LED_CONTROL_PIN, GPIO_LOW);
		}
	}
}
