...
static android_suspend_lock_t hub_suspend_lock;
#endif
...
void hub_disconnect_device()
{
    if(g_usb_device)
    {
        ...
        // cmy: 断开设备连接
    	hub_port_connect_change(hub, 1, 0x100, 0x3);
    }
}
...
#ifdef CONFIG_ANDROID_POWER
	hub_suspend_lock.name = "hubsuspendlock";
	android_init_suspend_lock(&hub_suspend_lock);
#endif
...
#ifdef CONFIG_ANDROID_POWER
	android_uninit_suspend_lock(&hub_suspend_lock);
#endif
