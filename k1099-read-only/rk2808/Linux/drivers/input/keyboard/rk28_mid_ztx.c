...
#define KEY_CAL				240
#define KEY_PAIHANG			241
#define KEY_SHAOMIAO		242
#define KEY_QMENU			243
#define KEY_TONGXUN		244
#define KEY_QHOME			245
...
static unsigned char initkey_code[ ] = 
{
	...
	AD2KEY1, AD2KEY2,AD2KEY3,AD2KEY4,AD2KEY5,AD2KEY6,AD2KEY7, AD2KEY8,AD2KEY9,AD2KEY10,AD2KEY11,AD2KEY12,AD2KEY13,AD2KEY14,ENDCALL	,KEY_WAKEUP
};
