...
// PB1->  Vbus Detect pin
#if 1  //zfl ÓëBoard_rk28.c ÖÐ  do_battery_charge_init ¶ÔÓ¦
#if( defined(CONFIG_BOARD_BM999 ) )
//#define Charg_En_Pin	GPIOPortB_Pin0	// 0 charging    1:full	//³äµçÆ÷·´À¡½Å
#define Charg_Detec_Pin	GPIOPortB_Pin3	// ³äµçÆ÷¼ì²â½Å£¬¼ì²âÊÇ·ñ²åÈë³äµçÆ÷
...
//#define Charg_State_Pin	GPIOPortB_Pin0	// 0 charging    1:full	//³äµçÆ÷·´À¡½Å
#define Charg_Detec_Pin	GPIOPortB_Pin0	// ³äµçÆ÷¼ì²â½Å£¬¼ì²âÊÇ·ñ²åÈë³äµçÆ÷
#else
#define Charg_State_Pin	GPIOPortB_Pin0	// 0 charging    1:full
#define Charg_Detec_Pin	GPIOPortB_Pin1
#define Charg_En_Pin		GPIOPortF_Pin0	// ³äµçÊ¹ÄÜ½Å
#endif
#endif
