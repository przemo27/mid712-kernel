...
#define PT2046_CS_SET_OUPUT()	    GPIOSetPinDirection(GPIOPortB_Pin0, GPIO_OUT)	
#define PT2046_CS_GET()		    GPIOGetPinLevel(GPIOPortB_Pin0)
#define PT2046_CS_SET()		    GPIOSetPinLevel(GPIOPortB_Pin0,GPIO_LOW)
#define PT2046_CS_CLR()		    GPIOSetPinLevel(GPIOPortB_Pin0,GPIO_HIGH)	
